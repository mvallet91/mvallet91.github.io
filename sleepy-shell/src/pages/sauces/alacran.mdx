...
coverImg: "/assets/img/alacran.jpg"
heroAlt: "El Alacrán hot sauce"
tags:
  - Trinidad Scorpion
  - Garlic
  - Confit
...
<div className="flex justify-center">
  <img src="/assets/img/alacran.jpg" alt="El Alacrán hot sauce" className="w-64 rounded-xl shadow" loading="lazy" />
</div>
...
10. Blend and taste! Add onion, black pepper and lime to taste. When tasting, let it evolve for a bit—the heat takes some time to fully reach its level.
11. Add warm water to thin, if preferred. Use a tablespoon of water at a time; the consistency can change quite quickly.
